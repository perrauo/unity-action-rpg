...
{
    public class AssetList : ScriptableObject, IList<BaseObject>
    {
        public BaseObject this[int index] { get => _list[index]; set => _list[index] = value; }

        public delegate void OnList(AssetList list);

        public delegate void OnListEvent(AssetList list, BaseObject obj);

        public delegate void OnListManyEvent(AssetList list, IEnumerable<BaseObject> objs);
