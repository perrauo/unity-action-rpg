...
namespace KinematicCharacterController.Walkthrough.NoClipState
{
    public class MyPlayer : MonoBehaviour
    {
        ...
        private void HandleCharacterInput()
        {
            ...
            characterInputs.JumpHeld = UnityEngine.Input.GetKey(KeyCode.Space);
            ...
            characterInputs.CrouchHeld = UnityEngine.Input.GetKey(KeyCode.C);
            characterInputs.NoClipDown = UnityEngine.Input.GetKeyUp(KeyCode.Q);
